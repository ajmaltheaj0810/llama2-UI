export default function SessionSidebar({ sessions, currentId, onSelect, onNew }) {
  return (
    <div className="w-80 bg-gradient-to-b from-black to-gray-900 text-white h-screen flex flex-col shadow-2xl">
        ...
        {sessions.length === 0 ? (
          ...
          sessions.map((session) => (
            <button
              ...
              className={`block w-full text-left px-6 py-4 hover:bg-gray-800/70 border-b border-gray-700/30 transition-all duration-200 group ${
